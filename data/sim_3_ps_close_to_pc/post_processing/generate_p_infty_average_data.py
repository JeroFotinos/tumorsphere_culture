...
file_list = glob.glob(
    "/home/nate/Devel/tumorsphere_culture/data/sim_3_ps_close_to_pc/dat_files/*.dat"
)
...
for p in set([x[0] for x in data_dict.keys()]):
    ...
    with open(
        "/home/nate/Devel/tumorsphere_culture/data/sim_3_ps_close_to_pc/p_infty_vs_t_averages/average-p_infty_vs_t-ps-{}.dat".format(
            p
        ),
        "w",
    ) as file:
...
for i in set([(x[1] + 1) for x in data_dict.keys()]):
    # Create a new file for the averages
    with open(
        "/home/nate/Devel/tumorsphere_culture/data/sim_3_ps_close_to_pc/p_infty_vs_ps_averages/average-p_infty_vs_ps-t-{}.dat".format(
            i
        ),
        "w",
    ) as file:
