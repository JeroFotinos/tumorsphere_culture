...
conda activate
srun tumorsphere simulate --prob-stem "0.65,0.66" --prob-diff "0" --realizations 32 --steps-per-realization 60 --rng-seed 3104902187430912364 --parallel-processes 64 --ovito False --dat-files False
