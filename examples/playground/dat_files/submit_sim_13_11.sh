...
### Nombre de la tarea
#SBATCH --job-name=tumorsphere_13_11
...
conda activate
srun tumorsphere simulate --prob-stem "0.75,.76" --prob-diff "0" --realizations 16 --steps-per-realization 60 --rng-seed 3104902187430912364 --parallel-processes 32 --ovito False --dat-files True
