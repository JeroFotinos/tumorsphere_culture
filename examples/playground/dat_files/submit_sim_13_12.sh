...
### Nombre de la tarea
#SBATCH --job-name=tumorsphere_13_12
...
conda activate
srun tumorsphere simulate --prob-stem "0.76,.77" --prob-diff "0" --realizations 16 --steps-per-realization 60 --rng-seed 3104902187430912364 --parallel-processes 32 --ovito False --dat-files True
