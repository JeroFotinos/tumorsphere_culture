...
conda activate
tumorsphere simulate --prob-stem "0.65,0.66" --prob-diff "0" --realizations 16 --steps-per-realization 60 --rng-seed 1292317634567 --parallel-processes 32 --ovito False
